 ...
 * This must be used along with {@link org.apache.paimon.utils.ReusingTestData}.
 */
public class ReusingKeyValue {
    ...
    public <K extends Comparable<K>, V> KeyValue update(
            ReusingTestData<K, V> data,
            BiConsumer<BinaryRowWriter, K> keyUpdater,
            BiConsumer<BinaryRowWriter, V> valueUpdater) {
        keyUpdater.accept(keyWriter, data.key);
        valueUpdater.accept(valueWriter, data.value);
